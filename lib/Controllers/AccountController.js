...
var AccountController = {
     ...
     */
    createViewAccount: function createViewAccount(input, callback) {
        // Assign default values
        input = input || {};
        // Validating required parameters
        if (input.date === null || input.date === undefined) {
            return callback({errorMessage: "The property 'date' in the input object cannot be null.", errorCode: -1}, null, null);
        }
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createViewAccount");
