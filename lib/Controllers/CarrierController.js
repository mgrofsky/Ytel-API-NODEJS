...
var CarrierController = {
     ...
     */
    createCarrierLookup: function createCarrierLookup(input, callback) {
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createCarrierLookup");
     ...
     * @return {string}	Returns an instance of string type
     */
    createCarrierLookupList: function createCarrierLookupList(input, callback) {
        // Assign default values
        input = input || {};
        // prepare query string for API call;
        var _baseUri = _configuration.getBaseUri();
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createCarrierLookupList");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                callback(null, _response.body, _context);
            } else {
