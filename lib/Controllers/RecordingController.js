...
class RecordingController {
     ...
     * @returns {Promise}
     */
    static viewRecording(input, callback) {
     ...
     * @returns {Promise}
     */
    static deleteRecording(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * response per page
     * @param {string} input['dateCreated'] (optional) Recording date
     * @param {string} input['callSid'] (optional) Call ID
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static listRecording(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
