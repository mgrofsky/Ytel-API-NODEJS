...
class CallController {
     ...
     * @returns {Promise}
     */
    static createCallsViewcalldetail(callSid, callback) {
     ...
     * @returns {Promise}
     */
    static createCallsViewcalls(callsid, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {PlayDtmfDirectionEnum} input['playDtmfDirection'] (optional) The leg of the call
     ...
     * @returns {Promise}
     */
    static createCallsSenddigits(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * call is finished.
     * @param {string} input['statsCallBackMethod'] (optional) Specifies the HTTP method used to
     ...
     * @returns {Promise}
     */
    static createCallsMakervm(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createCallsListcalls(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {string} input['method'] (optional) The method used to request the above Url
     * parameter
     * @param {Status24Enum} input['status'] (optional) Status to set the in-progress call to
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createCallsInterruptcalls(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {FileformatEnum} input['fileformat'] (optional) Format of the recording file. Can be .
     * mp3 or .wav
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     */
    static createCallsRecordcalls(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createCallsPlayaudios(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createCallsVoiceeffect(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {GroupConfirmFileEnum} input['groupConfirmFile'] Specify the audio file you want to
     * play when the called party picks up
     * the call
     * @param {string} input['method'] (optional) Specifies the HTTP method used to request the
     * required URL once call connects.
     * @param {string} input['statusCallBackUrl'] (optional) URL that can be requested to receive
     ...
     * @param {string} input['heartBeatMethod'] (optional) Specifies the HTTP method used to
     ...
     * upon completion
     * @param {string} input['recordCallBackMethod'] (optional) Method used to request the
     * RecordCallback URL.
     ...
     * @returns {Promise}
     */
    static createCallsGroupcall(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @param {string} input['ifMachineMethod'] (optional) Method used to request the IfMachineUrl.
     ...
     * @returns {Promise}
     */
    static createCallsMakecall(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
