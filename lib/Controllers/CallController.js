...
class CallController {
     ...
     * @param {int} input['timeout'] (optional) Time (in seconds) Ytel should wait while the call
     * is ringing before canceling the call
     ...
     * @param {IfMachineEnum} input['ifMachine'] (optional) How Ytel should handle the receiving
     ...
     * @param {HttpActionEnum} input['heartBeatMethod'] (optional) Specifies the HTTP method used
     * to request HeartbeatUrl.
     * @param {int} input['timeout'] (optional) Time (in seconds) we should wait while the call is
