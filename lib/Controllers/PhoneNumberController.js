...
class PhoneNumberController {
     ...
     * @param {HttpActionEnum} input['smsFallbackMethod'] (optional) The HTTP method Ytel will use
     ...
     * @param {HttpActionEnum} input['hangupCallbackMethod'] (optional) The HTTP method Ytel will
     * use when requesting the HangupCallback
     * URL.
     * @param {string} input['heartbeatUrl'] (optional) URL that can be used to monitor the phone
     * number.
     * @param {HttpActionEnum} input['heartbeatMethod'] (optional) The HTTP method Ytel will use
     * when requesting the HeartbeatUrl.
     * @param {string} input['smsUrl'] (optional) URL requested when an SMS is received.
     * @param {HttpActionEnum} input['smsMethod'] (optional) The HTTP method Ytel will use when
