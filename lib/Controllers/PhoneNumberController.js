...
class PhoneNumberController {
     ...
     * response per page
     * @param {NumberTypeEnum} input['numberType'] (optional) TODO: type description here
     * @param {string} input['friendlyName'] (optional) TODO: type description here
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
     ...
     * @param {string} input['responseType'] Response type format xml or json
     * @param {string} input['friendlyName'] (optional) TODO: type description here
     * @param {string} input['voiceUrl'] (optional) URL requested once the call connects
     * @param {HttpActionEnum} input['voiceMethod'] (optional) TODO: type description here
     * @param {string} input['voiceFallbackUrl'] (optional) URL requested if the voice URL is not
     * available
     * @param {HttpActionEnum} input['voiceFallbackMethod'] (optional) TODO: type description here
     * @param {string} input['hangupCallback'] (optional) TODO: type description here
     * @param {HttpActionEnum} input['hangupCallbackMethod'] (optional) TODO: type description
     * here
     ...
     * @param {HttpActionEnum} input['smsMethod'] (optional) TODO: type description here
