...
class PostCardController {
     ...
     * @returns {Promise}
     */
    static postcardDeletepostcard(postcardid, callback) {
     ...
     * @returns {Promise}
     */
    static postcardViewpostcard(postcardid, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static postcardListpostcard(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static postcardCreatepostcard(input, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
