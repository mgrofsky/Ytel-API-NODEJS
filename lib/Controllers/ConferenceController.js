...
class ConferenceController {
     ...
     * @param {string} input['responseType'] Response type format xml or json
     * @param {bool} input['muted'] (optional) add muted
     * @param {bool} input['deaf'] (optional) add without volume
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
    ...
    /**
     * Here you can experiment with initiating a conference call through message360 and view the
     ...
     * @param {HttpActionEnum} input['method'] Specifies the HTTP method used to request the
     * required URL once call connects.
     * @param {string} input['recordCallbackUrl'] Recording parameters will be sent here upon
     * completion.
     * @param {string} input['responseType'] Response type format xml or json
     ...
     * conference connects.
     * @param {string} input['schdeuleTime'] (optional) Schedule conference in future. Schedule
    ...
    static createConference(input, callback) {
        ...
        if (input.from === null || input.from === undefined) {
            ...
            const _err = { errorMessage: 'The property `recordCallbackUrl` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param {int} input['pagesize'] (optional) Amount of records to return per page
     * @param {bool} input['muted'] (optional) Participants that are muted
     * @param {bool} input['deaf'] (optional) Participants cant hear
     *
     * @callback    The callback function that returns response from the API call
     *
     * @returns {Promise}
