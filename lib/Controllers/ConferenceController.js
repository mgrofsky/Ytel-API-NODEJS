...
var ConferenceController = {
     ...
     */
    createDeafMuteParticipant: function createDeafMuteParticipant(input, callback) {
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createDeafMuteParticipant");
     ...
     * @return {string}	Returns an instance of string type
     */
    createListConference: function createListConference(input, callback) {
        // Assign default values
        input = input || {};
        // prepare query string for API call;
        var _baseUri = _configuration.getBaseUri();
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createListConference");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                callback(null, _response.body, _context);
            } else {
     ...
     * @return {string}	Returns an instance of string type
     */
    createViewConference: function createViewConference(input, callback) {
        // Assign default values
        input = input || {};
        // Validating required parameters
        if (input.conferencesid === null || input.conferencesid === undefined) {
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createViewConference");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                callback(null, _response.body, _context);
            } else {
     ...
     * @return {string}	Returns an instance of string type
     */
    addParticipant: function addParticipant(input, callback) {
        // Assign default values
        input = input || {};
        // Validating required parameters
        if (input.conferencesid === null || input.conferencesid === undefined) {
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "addParticipant");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                callback(null, _response.body, _context);
            } else {
     ...
     * @return {string}	Returns an instance of string type
     */
    createListParticipant: function createListParticipant(input, callback) {
        // Assign default values
        input = input || {};
        // Validating required parameters
        if (input.conferenceSid === null || input.conferenceSid === undefined) {
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createListParticipant");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                callback(null, _response.body, _context);
            } else {
     ...
     * @return {string}	Returns an instance of string type
     */
    createViewParticipant: function createViewParticipant(input, callback) {
        // Assign default values
        input = input || {};
        // Validating required parameters
        if (input.conferenceSid === null || input.conferenceSid === undefined) {
        ...
        var cb = function cb(_error, _response, _context) {
            var errorResponse;
            if (_error) {
                errorResponse = _BaseController.validateResponse(_context, "createViewParticipant");
                callback(errorResponse.error, errorResponse.response, errorResponse.context);
            } else if (_response.statusCode >= 200 && _response.statusCode <= 206) {
                callback(null, _response.body, _context);
            } else {
