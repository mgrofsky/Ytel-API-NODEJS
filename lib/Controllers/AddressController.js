...
class AddressController {
    ...
    static viewAddress(input, callback) {
        ...
        if (input.addressSID === null || input.addressSID === undefined) {
            const _err = { errorMessage: 'The property `addressSID` in the input object cannot be null.',
                errorCode: -1 };
            _callback(_err, null, null);
            return Promise.reject(_err);
        }
     ...
     * @param  {array}  input    Array with all options for search
     * @param {string} input['responseType'] Response Type either json or xml
     * @param {int} input['page'] (optional) Return requested # of items starting the value,
     ...
     * @param {string} input['addressSID'] (optional) addresses Sid
