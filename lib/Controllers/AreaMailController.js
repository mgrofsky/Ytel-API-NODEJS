...
class AreaMailController {
     ...
     * @returns {Promise}
     */
    static createDeleteAreaMail(areamailid, callback) {
     ...
     * @returns {Promise}
     */
    static createViewAreaMail(areamailid, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     * @returns {Promise}
     */
    static createListAreaMails(page, pagesize, areamailsid, dateCreated, callback) {
        // create empty callback if absent
        const _callback = typeof callback === 'function' ? callback : () => undefined;
     ...
     *
     * @param {string} routes List of routes that AreaMail should be delivered to.  A single route
     ...
     * @param {string} front The front of the AreaMail item to be created. This can be a URL, local
     * file, or an HTML string. Supported file types are PDF, PNG, and JPEG.
     * Back required
     * @param {string} back The back of the AreaMail item to be created. This can be a URL, local
     * file, or an HTML string. Supported file types are PDF, PNG, and JPEG.
     * @param {string} description (optional) A string value to use as a description for this
     * AreaMail item.
