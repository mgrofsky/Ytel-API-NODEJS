...
class TranscriptionController {
     ...
     * @param {int} input['pageSize'] (optional) Amount of data per page
     * @param {StatusEnum} input['status'] (optional) Transcription status
     * @param {string} input['dateTranscribed'] (optional) Transcription date
     *
